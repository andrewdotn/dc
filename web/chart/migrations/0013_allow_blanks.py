...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Chart.source_url'
        db.delete_column('chart_chart', 'source_url')


    def backwards(self, orm):
        
        # Adding field 'Chart.source_url'
        db.add_column('chart_chart', 'source_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200), keep_default=False)
