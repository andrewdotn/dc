...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chart.y_axis_description'
        db.alter_column('chart_chart', 'y_axis_description', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Chart.y_axis_description'
        db.alter_column('chart_chart', 'y_axis_description', self.gf('django.db.models.fields.TextField')(max_length=255))
