...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chart.creator'
        db.add_column('chart_chart', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chart.creator'
        db.delete_column('chart_chart', 'creator_id')
