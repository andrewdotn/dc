...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chart.chart_width'
        db.add_column('chart_chart', 'chart_width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Chart.chart_width'
        db.delete_column('chart_chart', 'chart_width')
    ...
    models = {
        ...
        'chart.chart': {
            ...
            'tweet': ('django.db.models.fields.CharField', [], {'max_length': '140', 'blank': 'True'}),
