...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Chart.tweet'
        db.delete_column('chart_chart', 'tweet')

        # Deleting field 'Chart.short_name'
        db.delete_column('chart_chart', 'short_name')


    def backwards(self, orm):
        
        # Adding field 'Chart.tweet'
        db.add_column('chart_chart', 'tweet', self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True), keep_default=False)

        # Adding field 'Chart.short_name'
        db.add_column('chart_chart', 'short_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
