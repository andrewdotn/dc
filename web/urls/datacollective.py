...
urlpatterns = patterns('',
    ...
    (r'^friends/$', render, {'template_name': 'friends.html'}, 'friends'),
    (r'^jobs/$', render, {'template_name': 'jobs.html'}, 'jobs'),
    (r'^speed$', render, {'template_name': 'about_speed.html'}, 'about_speed'),
